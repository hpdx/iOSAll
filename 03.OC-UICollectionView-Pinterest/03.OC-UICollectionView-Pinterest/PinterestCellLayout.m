...
@implementation PinterestCellLayout
{
    //这个数组就是我们自定义的布局配置数组
...
- (void)prepareLayout
{
    ...
    for (int i=0; i<_itemCount; i++) {
        ...
        //随机一个高度
        CGFloat hight = arc4random()%200+100;
        //哪一列高度小 则放到那一列下面
        ...
        //设置item的位置
        attris.frame = CGRectMake(self.sectionInset.left + (self.minimumInteritemSpacing + WIDTH)*width,
                                  colHight[width] - hight - self.minimumLineSpacing, WIDTH, hight);
